 ...
 * 
 * Two queues in pairs are built by 2 {@link UnreliableStack} and one shared {@link ReliableStack}</br> 
 * @author btdiem
 *
 */
public class JUnit_QueueShareStackIntPairSimulation_ReliableStack extends JUnit_AbstractQueueIntPairSimulation{
